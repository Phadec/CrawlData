...
async function saveToExcel(tiviData) {
    ...
    worksheet.columns = [
        ...
        { header: 'Screen Size', key: 'Kích cỡ màn hình', width: 25 },
        { header: 'Resolution', key: 'Độ phân giải', width: 25 },
        { header: 'Screen Type', key: 'Loại màn hình', width: 25 },
        { header: 'Operating System', key: 'Hệ điều hành', width: 25 },
        { header: 'Image Technology', key: 'Công nghệ hình ảnh', width: 30 },
        { header: 'Processor', key: 'Bộ xử lý', width: 25 },
        { header: 'Refresh Rate', key: 'Tần số quét thực', width: 25 },
        { header: 'Speaker Power', key: 'Tổng công suất loa', width: 25 },
        { header: 'Internet Connection', key: 'Kết nối Internet', width: 25 },
        { header: 'Wireless Connectivity', key: 'Kết nối không dây', width: 25 },
        { header: 'USB Ports', key: 'USB', width: 25 },
        ...
        { header: 'Stand Material', key: 'Chất liệu chân đế', width: 25 },
        { header: 'Bezel Material', key: 'Chất liệu viền tivi', width: 25 },
        { header: 'Manufacturer', key: 'Hãng', width: 25 },
        { header: 'Manufactured In', key: 'Nơi sản xuất', width: 25 },
        { header: 'Release Year', key: 'Năm ra mắt', width: 25 },
